...
curl -v -X POST -d '{"defId":"test_def","rptType":"PDF","retentionDays":0,"reportParameters":null}' -H "Content-type: application/vnd.ksmpartners.ernie+json" --header "Accept: application/vnd.ksmpartners.ernie+json" --header "Authorization: SAML tVdbc7JMEr73V1i+lynDQVGxolXDyYCCQRGjN1scRkA5yQxC/PWLmFgxm7yb3arviuqe7qef7p5D\
...
xdf9/I/z3SMnwfj3hImfG098+QsY/xs=" https://0.0.0.0:8080/jobs
