...
curl -v -X POST -T req.json\
  -H "Accept: application/vnd.ksmpartners.ernie+json"\
  -H "Authorization: SAML tVdbc7JMEr73V1i+lynDQVGxolXDyYCCQRGjN1scRkA5yQxC/PWLmFgxm7yb3arviuqe7qef7p5D\
...
xdf9/I/z3SMnwfj3hImfG098+QsY/xs=" https://dev.ksmpartners.com/ernie/jobs
