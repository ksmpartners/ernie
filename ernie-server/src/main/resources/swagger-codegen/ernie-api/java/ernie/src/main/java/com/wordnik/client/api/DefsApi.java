...
public class DefsApi {
  ...
  public ReportDefinitionMapResponse getDefinitionHead (String Authorization, String Accept) throws ApiException {
    // create path and map variables
    String path = "/defs".replaceAll("\\{format\\}","json");
  ...
  public DefinitionEntity getDefinitionDetailHead (String def_id, String Authorization, String Accept) throws ApiException {
    // create path and map variables
    String path = "/defs/{def_id}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "def_id" + "\\}", apiInvoker.escapeString(def_id.toString()));
