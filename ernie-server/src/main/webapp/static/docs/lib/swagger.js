...
(function() {
  ...
  SwaggerApi = (function() {
    ...
    SwaggerApi.prototype.build = function() {
      ...
      return jQuery.ajax({ url: this.discoveryUrl, type: 'GET',  crossDomain:true, beforeSend: function(xhr) {
                                                                                var k, v, _ref, _results;
                                                                                _ref = _this.headers;
                                                                                _results = [];
                                                                                for (k in _ref) {
                                                                                  v = _ref[k];
                                                                                  _results.push(xhr.setRequestHeader(k, v));
                                                                                }
                                                                                return _results;
    ...
    function SwaggerRequest(type, url, headers, body, successCallback, errorCallback, operation) {
      ...
      if (this.headers.mock == null) {
        obj = {
          ...
          dataType: 'application/vnd.ksmpartners.ernie+json',
          error: function(xhr, textStatus, error) {
